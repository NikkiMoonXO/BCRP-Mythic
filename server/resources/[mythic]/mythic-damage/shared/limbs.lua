...
Config.WeaponClassBindings = {
	...
	[`WEAPON_HEAVYPISTOL`] = Config.WeaponClasses["SMALL_CALIBER"],
	[`WEAPON_MARKSMANPISTOL`] = Config.WeaponClasses["SMALL_CALIBER"],
	[`WEAPON_PISTOL50`] = Config.WeaponClasses["SMALL_CALIBER"],
