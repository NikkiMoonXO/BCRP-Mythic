...
AddEventHandler("Core:Shared:Ready", function()
	exports["mythic-base"]:RequestDependencies("Robbery", {
		...
		}, _heistTools, "dollar-sign", "View Offers", false, 1, true, 60 * math.random(30, 60))
		...
		Vendor:Create("HeistShit", "ped", "Rob Tools", GetHashKey("CS_NervousRon"), {
			...
			heading = pos.w,
		}, _toolsForSale, "dollar-sign", "View Offers", 1, false, true, 60 * math.random(30, 60), 60 * math.random(240, 360))
		...
		Vendor:Create("ScamSchemSeller", "ped", "Dom's Deals", GetHashKey("a_m_m_eastsa_02"), {
			...
			heading = pos2.w,
		}, _schemSeller, "dollar-sign", "View Offers")
