...
function Startup()
	Targeting.Zones:AddBox("burgershot-clockinoff", "clock", vector3(-1177.08, -896.98, 13.79), 0.4, 0.4, {
		heading = 35,
		--debugPoly=true,
		minZ = 13.39,
		maxZ = 14.59,
	...
	Targeting.Zones:AddBox("rustybrowns-clockinoff", "clock", vector3(164.9, 247.96, 107.05), 1, 0.8, {
		heading = 340,
		--debugPoly=true,
		minZ = 103.65,
		maxZ = 107.65,
	...
	Targeting.Zones:AddBox("bahama-clockinoff", "clock", vector3(-1398.88, -600.11, 30.32), 0.6, 0.6, {
		heading = 11,
		--debugPoly=true,
		minZ = 29.32,
		maxZ = 31.32,
	...
	Targeting.Zones:AddBox("bahama-clockinoff2", "clock", vector3(-1402.88, -602.59, 30.32), 0.6, 0.4, {
		heading = 145.994,
		--debugPoly=true,
		minZ = 29.32,
		maxZ = 31.32,
