COMPONENTS.Discord = {
	...
	RichPresence = function(self)
		...
		SetDiscordRichPresenceAsset("MYTHICRP_large_icon")
		SetDiscordRichPresenceAssetText("Join Today: MythicRP.gg")
		--SetDiscordRichPresenceAssetSmall("info")
		SetDiscordRichPresenceAction(0, "Apply Now", "https://mythicrp.gg")
		SetDiscordRichPresenceAction(1, "Join Our Discord", "https://discord.gg/mythicgg")
