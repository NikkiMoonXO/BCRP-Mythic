local vendingMachines = {
	...
	{ model = `prop_vend_soda_01`, shop = "vending-drinks", icon = "droplet" },
	{ model = `prop_vend_soda_02`, shop = "vending-drinks", icon = "droplet" },
	{ model = `v_68_broeknvend`, shop = "vending-drinks", icon = "droplet" },
	...
	{ model = 486135101, shop = "fuel-pump", icon = "gas-pump", text = "Buy Petrol Can" }, -- gabz LTD grove
	{ model = `prop_hotdogstand_01`, shop = "vending-hotdog", icon = "hotdog", text = "Buy Hot Dog" },
	{ model = `prop_burgerstand_01`, shop = "vending-burger", icon = "burger", text = "Buy Burger" },
}
