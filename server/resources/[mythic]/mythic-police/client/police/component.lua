...
AddEventHandler("Core:Shared:Ready", function()
	exports["mythic-base"]:RequestDependencies("Police", {
		...
		Targeting.Zones:AddBox("pd-clockinoff-guardius", "clipboard-list", vector3(-1083.75, -247.15, 37.76), 1.2, 2, {
			heading = 27,
			--debugPoly=true,
			minZ = 36.76,
			maxZ = 38.96
		...
		Targeting.Zones:AddBox("pd-clockinoff-guardius2", "clipboard-list", vector3(-1049.57, -231.01, 39.02), 1, 1, {
			heading = 300,
			--debugPoly=true,
			minZ = 38.02,
			maxZ = 40.22
		...
		Targeting.Zones:AddBox("police-shitty-locker-6", "clipboard-list", vector3(-1061.09, -247.43, 39.74), 3.6, 1, {
			heading = 27,
			--debugPoly=true,
			minZ = 38.74,
			maxZ = 41.34
		...
		Targeting.Zones:AddBox("ems-shitty-locker-1", "clipboard-list", vector3(1142.12, -1539.54, 35.03), 4.2, 0.6, {
			heading = 0,
			--debugPoly=true,
			minZ = 32.23,
			maxZ = 36.23
